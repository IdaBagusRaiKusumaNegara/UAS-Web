            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('create-pekerja')}}" style="margin-left: 590px;" class="btn btn-success"><i
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $item->nama }} </td>
                                    <td>
                                        <a href="{{ url('edit-pekerja', $item->id) }}"><i class="fas fa-edit"
                                                style="color: gold;"></i></a>
                                        |
                                        <a href="#modalDelete" data-toggle="modal"
                                            onclick="$('#modalDelete #formDelete').attr('action','<?= url('delete-pekerja', $item->id) ?>')"><i
